class HomeController < ApplicationController
	...
	def user
		...
		render json:{user:@user,events:@events,isFollowed:@isFollowed,iscurrentUser:@iscurrentUser,gravatar_url:@gravatar_url,followed_count:@followed_count,followers_count:@followers_count,paginate:[@page_floor,@page_ceiling,current_page,@user.id,@page_count]}
	end
